...
enum DemoData {
    ...
    static let offers: [Offer] = [
        Offer(id: UUID(uuidString: "1130C76A-640F-4C0B-9117-D29D49323101")!,
              ...
              distanceMetres: 350, ownerName: "Mara", collectorName: nil, status: .open, createdAt: Date().addingTimeInterval(-900)),
        Offer(id: UUID(uuidString: "1130C76A-640F-4C0B-9117-D29D49323102")!,
              ...
              distanceMetres: 2_400, ownerName: "Jens", collectorName: nil, status: .open, createdAt: Date().addingTimeInterval(-2_400)),
        Offer(id: UUID(uuidString: "1130C76A-640F-4C0B-9117-D29D49323103")!,
              ...
              distanceMetres: 3_100, ownerName: "Leyla", collectorName: nil, status: .open, createdAt: Date().addingTimeInterval(-3_600)),
        Offer(id: UUID(uuidString: "1130C76A-640F-4C0B-9117-D29D49323104")!,
              ...
              distanceMetres: 4_200, ownerName: "Tobias", collectorName: "Du", status: .claimed, createdAt: Date().addingTimeInterval(-7_200)),
        Offer(id: UUID(uuidString: "1130C76A-640F-4C0B-9117-D29D49323105")!,
              ...
              distanceMetres: 5_600, ownerName: "Aylin", collectorName: nil, status: .open, createdAt: Date().addingTimeInterval(-4_800)),
        Offer(id: UUID(uuidString: "1130C76A-640F-4C0B-9117-D29D49323106")!,
              ...
              distanceMetres: 6_300, ownerName: "Nora", collectorName: nil, status: .open, createdAt: Date().addingTimeInterval(-5_400)),
        Offer(id: UUID(uuidString: "1130C76A-640F-4C0B-9117-D29D49323107")!,
              ...
              distanceMetres: 7_800, ownerName: "Can", collectorName: nil, status: .open, createdAt: Date().addingTimeInterval(-6_300)),
        Offer(id: UUID(uuidString: "1130C76A-640F-4C0B-9117-D29D49323108")!,
              ...
              distanceMetres: 5_100, ownerName: "Omar", collectorName: nil, status: .open, createdAt: Date().addingTimeInterval(-7_000))
    ]
}
